...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <!--<meta name="description" content="My Morocco Magazine" />-->

    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <?php
	if(isset($_GET['image']))
	{
		echo $title = $_GET['image'];
	}
    ...
    <meta name="description" content="My Morocco">
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><script async src="js?x=mainHome"></script>

<meta property="og:title" content="testting title" />
<meta property="og:type" content="article" />
<meta property="og:image" content="" />
<meta property="og:url" content="mymorocco.ae" />


    <script src="http://code.jquery.com/jquery-migrate-1.2.1.min.js"></script><script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js"></script><link href="system/sys-references/css/style.css" rel="stylesheet" type="text/css"><link href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet" type="text/css"><link href="http://fonts.googleapis.com/css?family=Raleway:400,500&amp;subset=latin,latin-ext&amp;v=.css" rel="stylesheet" type="text/css"><link href="http://fonts.googleapis.com/css?family=Poiret+One&amp;v=.css" rel="stylesheet" type="text/css"><link href="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css" rel="stylesheet" type="text/css"><link href="http://cdnjs.cloudflare.com/ajax/libs/bootstrap-rtl/3.1.2/css/bootstrap-rtl.min.css" rel="stylesheet" type="text/css"><script src="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script><link href="css?x=mainHome&amp;v=.css" rel="stylesheet" type="text/css"><script src="js?x=sticky&amp;v=.js"></script><script src="js?x=localscroll&amp;v=.js"></script><script src="js?x=scrollTo&amp;v=.js"></script><script src="http://cdnjs.cloudflare.com/ajax/libs/jquery-timeago/0.11.4/jquery.timeago.js"></script><script src="js?x=touchSwipe&amp;v=.js"></script><script src="js?x=parallax&amp;v=.js"></script><script src="js?x=appear&amp;v=.js"></script><script src="js?x=prettyPhoto&amp;v=.js"></script><script src="js?x=isotope&amp;v=.js"></script><script src="js?x=bxslider&amp;v=.js"></script><script src="js?x=cycleAll&amp;v=.js"></script><script src="js?x=maximage&amp;v=.js"></script><script src="js?x=sscr&amp;v=.js"></script><script src="js?x=skrollr&amp;v=.js"></script><script src="js?x=jigowatt&amp;v=.js"></script><script src="js?x=scripts&amp;v.js"></script><link href="css?x=navigationStyle1&amp;v=.css" rel="stylesheet" type="text/css"><link href="css?x=navigationStyle2&amp;v=.css" rel="stylesheet" type="text/css"><link href="css?x=navigationStyle3&amp;v=.css" rel="stylesheet" type="text/css"><link href="css?x=navigationStyle4&amp;v=.css" rel="stylesheet" type="text/css"><link href="css?x=prettyPhoto&amp;v=.css" rel="stylesheet" type="text/css"><link href="css?x=style&amp;v=.css" rel="stylesheet" type="text/css"><link href="css?x=bxslider&amp;v=.css" rel="stylesheet" type="text/css">
...
<body onload="sysBoot.init();" data-spy="scroll" data-target=".navbar" data-offset="75">
...
<div class="modal fade bs-example-modal-lg"  id="topicReadMore"  tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  ...
  <p>
            ...
            <div class="SOMsharese"></div>

        </p>
         <p class="p30" style="padding-bottom:10px;">

        <span class="label label-info"></span> | <span class="label label-default"></span> |  <span id="counter" class="label label-success"><br>
        	...
        	<div class="container no-padding" style="background:rgba(0,0,0,.7);">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="menu-1 hidden-xs"><a class="colapse-menu1" href="#home"><img src="system/sys-references/images/top_logo.png"/></a></li>
                    ...
                    <div id="lastTopicsList_tow">
                        ...
                        <ul>
                            ...
                            ?>
                             ...
                             <a href="system.home.topics.php?&id=<?php echo $row['id']; ?>"><li data-id="<?=$row['id'];?>" id="data<?=$row['id'];?>" style="background-image:url('system/sys-references/images/topics/<?=$row['images'];?>');"><div class="title"><?=$row['title'];?></div></li></a>
